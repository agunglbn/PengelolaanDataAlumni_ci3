<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Detail Data Alumni
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Profile Alumni</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <form enctype="multipart/form-data" id="" method="GET">
                        ...
                        <div class="box-footer">
                            <a class="btn btn-primary" href="<?php echo base_url(); ?>dataAlumni" name="submit">Back</a>
