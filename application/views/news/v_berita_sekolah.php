                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <h2><i class="fa fa-star bg-orange"></i> Berita Sekolah <small
                                    class="hidden-xs-down hidden-sm-down">Berita Sekolah SMPN 25 Pekanbaru
                                </small></h2>
                        </div><!-- end col -->
                        <div class="col-lg-4 col-md-4 col-sm-12 hidden-xs-down hidden-sm-down">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>front">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Berita Sekolah </a></li>
                                <li class="breadcrumb-item active">SMPN 25 Pekanbaru</li>
                            </ol>
                        </div><!-- end col -->
                    </div><!-- end row -->
                </div><!-- end container -->
                ...
                <div class="container">
                    <div class="row">
                                ...
                                <div class="blog-list clearfix">
                                    ...
                                    <div class="blog-box row">
                                        ...
                                        <div class="blog-meta big-meta col-md-8">
                                            <h4><a href="<?php echo base_url() . 'DetailBeritaSekolah/' . $row->id; ?>"
                        ...
                        <!-- end blog-box --
                                ...
                                <div class="widget">
                                    <a href="<?php echo base_url(); ?>beritaAlumni">
