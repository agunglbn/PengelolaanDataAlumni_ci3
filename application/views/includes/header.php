    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?php echo base_url(); ?>" class="logo">
                ...
                <span class="logo-lg"><b>SMPN 25 </b>Pekanbaru</span>
            </a>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo base_url(); ?>BeritaAlumni"><i class="fa fa-circle-o"></i> List
                                    Berita Alumni</a>
                            </li>
                            <li><a href="<?php echo base_url(); ?>KategoriBeritaAlumni"><i class="fa fa-circle-o"></i>
                                    Kategori Berita Alumni</a>
                            </li>
                    ...
                    <!-- <li class="treeview">
                        <a href="#">
                            <i class="fa fa-user"></i> <span>Data Alumni</span>
                            <span class="pull-right-container">
                                <i c    lass="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="<?php echo base_url(); ?>alumni"><i class="fa fa-circle-o"></i> Data
                                    Alumni</a>
                            </li>
                    <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i> Data Siswa</a>
                    </li>
                    ...
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-book"></i> <span>Berita Sekolah</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo base_url(); ?>beritasekolah"><i class="fa fa-circle-o"></i> List
                                    Berita</a>
                            </li>
                            <li><a href="<?php echo base_url(); ?>KategoriBeritaSekolah"><i class="fa fa-circle-o"></i>
                                    Kategori Berita</a>
                            </li>
