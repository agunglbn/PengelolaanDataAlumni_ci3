...
<head>
    ...
    <!-- Vendor CSS Files -->
    <link href="<?php echo base_url(); ?>assets/front/assets/vendor/animate.css/animate.min.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/front/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/front/assets/vendor/bootstrap-icons/bootstrap-icons.css"
        rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/front/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Berita</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a class="nav-link scrollto" href="<?php echo base_url(); ?>BeritaSekolah">Berita
                                    Sekolah</a></li>
                            <li><a class="nav-link scrollto" href="<?php echo base_url(); ?>beritaAlumni">Berita
                                    Alumni</a></li>
                        </ul>
                    </li>
                    </li>
          ...
          <li><a href="#">Drop Down 4</a></li>
                    ...
                    <li class="dropdown"><a class="getstarted scrollto" href="#"><span> Login</span><i></i></a>
                        <ul>
                            <li><a href="<?php echo base_url(); ?>login">Login Admin/User</a></li>
                            <li><a href="<?php echo base_url(); ?>viewAlumniLogin">Login Alumni</a></li>
                        </ul>
