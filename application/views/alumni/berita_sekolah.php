...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Berita Sekolah
            <small>List Berita Sekolah</small>
        </h1>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>TambahBeritaSekolah"><i
                            class="fa fa-plus"></i>
                        Add New</a>
                </div>
            </div>
                                ...
                                <tr class="text-center">
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?php echo base_url() ?>StatusBeritaSekolah"
                                                            method="POST">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                    ...
                                    <td width="150px">
                                        ...
                                        <a class="btn btn-sm btn-info"
                                            href="<?php echo base_url() . 'EditBeritaSekolah/' . $record->id; ?>"><i
                                                class="fa fa-pencil"></i></a>
                                        <a class="btn btn-sm btn-danger" href="#modalDelete"
                                            onclick="$('#modalDelete #formDelete')
                                        .attr('action','<?php echo base_url() . 'deleteBeritaSekolah/' . $record->id; ?>')" data-toggle="modal"><i
