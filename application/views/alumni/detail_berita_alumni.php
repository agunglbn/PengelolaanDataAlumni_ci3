            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header">
                        <h3 class="box-title">Detail Berita
                    ...
                    <div class="box-body pad">
                        ...
                        <form enctype="multipart/form-data" id="" action="" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" value="<?php echo $detail->username ?>"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="judul" readonly
                                    placeholder="Masukkan Judul Berita ..." value="<?php echo $detail->kategori ?>">
                                <?php echo form_error('kategori', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <textarea id="editor1" readonly name="isi" rows="10" cols="80"
                                value="<?= set_value('isi'); ?>">
                            <?php echo $detail->isi ?>
                                </textarea>
