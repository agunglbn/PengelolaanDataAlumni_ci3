<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Kategori Berita Alumni
            <small>Profile</small>
        </h1>
    </section>
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td width="150px">
                                        ...
                                        .attr('action','<?php echo base_url() . 'deleteKategoriAlumni/' . $record->id; ?>')" data-toggle="modal"><i
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Kategori Alumni</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?php echo base_url() ?>TambahKategori" method="POST">
                        <div class="row">
                            <div class="col-md-12">
